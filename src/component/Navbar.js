...
export default function Navbar({className}) {
  ...
  return (
    <nav
      className={` text-white flex justify-between items-center py-3 px-5 sm:px-10 backdrop-blur-sm nav-border z-50 fixed w-[100%] ${className || 'bg-[rgba(73, 73, 73, 0.02)'}`}    >
      {/* Logo */}
