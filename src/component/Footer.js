...
export default function Footer() {
  return (
    <div
      ...
      className="bg-black relative bg-cover bg-center bg-footerGradient py-[70px] smd:py-0 sm:pt-[15px] px-8  smd:px-[40px] lg:px-[68px] flex m-auto gap-8"
    >
        ...
        <div className="flex flex-col gap-[24px] justify-center">
          ...
          <div className="flex flex-col gap-[40px]">
            <p className="font-jura text-[12px] lg:text-[14px] text-white uppercase">
              A future world adventure saga explored through art and <br className="460:block zero:hidden" />
