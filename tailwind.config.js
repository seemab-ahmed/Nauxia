...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundColor: {
        footerGradient: "linear-gradient(180deg, #151515 0%, rgba(0, 0, 0, 0) 100%)",
        highlightAnime: "linear-gradient(88.16deg, #FF003D -32.4%, #0085FF 73.16%)",
      },
      backdropFilter: {
        none: "none",
        blur: "6px",
      ...
      boxShadow: {
        'custom': '0px -6.308411598205566px 37.850467681884766px 0px rgba(255, 255, 255, 0.4)',
